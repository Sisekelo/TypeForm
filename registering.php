  ...
  <div class="container">
    ...
    <form action="index.php" method="post" class="form" id="registerform">
           ...
           <div id="else">
            ...
            <input  type="tel" id="number" pattern="[+]{1}[0-9]{11}" name="cellnumber" title="Please use your number starting with '+' & your number with country code." onblur="FixNumber()" placeholder ="+XXXXXXXXXXX" required>
            <input type="text" required autocomplete="off" name='room' placeholder="room number" />
