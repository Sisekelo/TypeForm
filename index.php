...
<head>
  ...
  <meta name="description" content="Just tell us what you want to eat once.
We will deliver it to you on time.">
...
<!--  <script type='text/javascript' src='//platform-api.sharethis.com/js/sharethis.js#property=5a2452f631a40500136712dd&product=sticky-share-buttons' async='async'></script>-->
  ...
  <meta property="og:description" content="Just tell us what you want to eat once.
We will deliver it to you on time.">

  <title>Oui Eat</title>
  <link rel="shortcut icon" type="image/png" href="img/eating.jpg"/>
      ...
      <div class="container">
         <div class="row header-info">
          <div class="col-sm-10 col-sm-offset-1 text-center">
            ...
            <br />
            <p class="lead wow fadeIn" data-wow-delay="0.5s">Just tell us what you want to eat once.<br>
            We will deliver it to you on time.</p>
